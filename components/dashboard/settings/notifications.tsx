  ...
  const items = [
    {
      ...
      desc: "Get notified when your payslip is available",
    },
    {
      key: "leave" as const,
      label: "Leave status updates",
      desc: "When your leave requests are approved or rejected",
    },
    {
      key: "dtr" as const,
      label: "DTR corrections",
      desc: "When time record corrections are processed",
    },
    {
      key: "announcements" as const,
      label: "Company announcements",
      desc: "General company news and updates",
    },
    {
      key: "digest" as const,
      label: "Weekly digest",
      desc: "Summary of your week every Friday",
    },
  ]
