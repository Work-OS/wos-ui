...
import { Clock01Icon, Logout01Icon, ShieldUserIcon } from "@hugeicons/core-free-icons"
...
export function SessionWarningModal() {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-sm animate-in fade-in zoom-in-95 duration-200 rounded-2xl border border-border bg-card shadow-2xl">
        {/* Header strip */}
        <div className={cn(
        ...
        <div className="px-6 py-5 space-y-4">
            ...
            <>
              ...
              <div className="flex flex-col items-center gap-3">
                <div className="relative flex size-24 items-center justify-center">
                  <svg className="absolute inset-0 -rotate-90" width="96" height="96">
                    ...
                    <circle
                      ...
                      stroke={countdown <= 30 ? "var(--red, #ef4444)" : "var(--warning, #f59e0b)"}
                      strokeWidth="6"
                      strokeLinecap="round"
                ...
                <p className="text-center text-[13px] text-muted-foreground">
                  Your session will automatically expire and you&apos;ll be logged out.
                </p>
              </div>
          ...
          {isExpired ? (
            ...
            <div className="flex gap-2">
              <Button
                variant="outline"
                className="flex-1 gap-2 text-danger border-danger-border hover:bg-danger-light"
              ...
              >
                <HugeiconsIcon icon={ShieldUserIcon} size={13} strokeWidth={2} />
